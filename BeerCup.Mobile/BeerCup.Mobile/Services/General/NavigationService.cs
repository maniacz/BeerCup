...
namespace BeerCup.Mobile.Services.General
{
    public class NavigationService : INavigationService
    {
        ...
        private void CreatePageViewModelMappings()
        {
            ...
            _mappings.Add(typeof(ResultsDetailViewModel), typeof(ResultsDetailView));
            _mappings.Add(typeof(ScheduleCatalogViewModel), typeof(ScheduleCatalogView));
            _mappings.Add(typeof(ScheduleDetailViewModel), typeof(ScheduleDetailView));
            _mappings.Add(typeof(ManageBattlesViewModel), typeof(ManageBattlesView));
            _mappings.Add(typeof(AddNewBattleViewModel), typeof(AddNewBattleView));
            ...
            _mappings.Add(typeof(AssignFirstRoundViewModel), typeof(AssignFirstRoundView));
            _mappings.Add(typeof(AddBreweryToFirstRoundBattleViewModel), typeof(AddBreweryToFirstRoundBattleView));
        }
